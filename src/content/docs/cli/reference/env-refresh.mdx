...
- [`xg env activate`](./env-activate.mdx) — activate an environment and optionally pre-warm the metadata cache
- [`xg env status`](./env-status.mdx) — display the currently active environment
- [CLI Reference](../index.mdx) — full index of available commands
