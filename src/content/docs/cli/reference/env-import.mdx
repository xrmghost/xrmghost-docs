...
- [`xg env template`](./env-template.mdx) — Generate a blank environment configuration JSON ready to fill in and import.
- [`xg env list`](./env-list.mdx) — List all currently registered Dataverse environments.
- [CLI Overview](../index.mdx) — Introduction to the `xg` CLI, command groups, and how this documentation is organised.
