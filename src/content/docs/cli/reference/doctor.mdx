...
:::tip
Running `ghost-plugin-cli doctor --verbose` before reporting a bug gives you a complete diagnostic snapshot — including resolved paths, version strings, and subscription claims — that significantly speeds up support.
:::
...
- [CLI Reference](./index.mdx) — overview of the reference area and command groups
- [CLI Command Groups](./command-groups.mdx) — all command groups and their intended reference-page shape
- [Getting Started with the CLI](../getting-started.mdx) — first-time orientation and safe exploration path
- [CLI Overview](../index.mdx) — role of the CLI in the XrmGhost ecosystem
