...
| [Manual Attribute Reference](./reference/index.mdx) | Browse one manual reference page per current public attribute while generated exports do not yet exist. |
...
The current public contract in `xrmghost-attributes` is the source of truth. The new [manual attribute reference](./reference/index.mdx) is authored by hand from that contract today, and it can later be replaced or supplemented by generated output when the schema pipeline exists.
