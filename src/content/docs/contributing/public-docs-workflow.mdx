...
1. Open [Content Ownership](/architecture/content-ownership/).
...
> See [Content Ownership — CLI Ownership Boundary](/architecture/content-ownership/) for the authoritative ownership split, and [Generated vs Manual — CLI Generation Contract](/architecture/generated-vs-manual/) for the full generation rules.
...
3. Request a review from at least one person on the owning team (see [Content Ownership](/architecture/content-ownership/)).
...
- [ ] Confirmed correct product owner in [Content Ownership](/architecture/content-ownership/)
