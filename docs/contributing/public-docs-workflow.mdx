...
description: Step-by-step workflow for adding a new page to the XrmGhost public documentation, including frontmatter rules, folder naming conventions, and how to find the right product owner.
---
