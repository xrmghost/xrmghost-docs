...
- [xg env list](./env-list.mdx) — List all registered Dataverse environments with full connection details
- [xg env activate](./env-activate.mdx) — Set a registered environment as the active one
