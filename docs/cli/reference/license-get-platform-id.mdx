...
- [`xg license activate`](./license-activate.mdx) — activate a license using a bootstrap key (requires the Platform ID)
- [`xg license status`](./license-status.mdx) — view current license tier, expiration, and subscription details
