...
- Use the [manual attribute reference](./reference/index.mdx) for one page per current public attribute, backed by the current public contract in `xrmghost-attributes` as the source of truth.
...
- [Manual Attribute Reference](./reference/index.mdx)
